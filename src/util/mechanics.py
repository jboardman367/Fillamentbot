...
def long_right(packet):
    #the kickoff
    active_sequence=Sequence([
        ControlStep(duration=0.55, controls=SimpleControllerState(boost=True,throttle=1,steer=-0.45)),
        ControlStep(duration=0.12, controls=SimpleControllerState(boost=True,throttle=1,steer=1)),
        ControlStep(duration=0.05, controls=SimpleControllerState(boost=True,throttle=1,jump=True)),
        ControlStep(duration=0.02, controls=SimpleControllerState(boost=True,throttle=1,jump=False)),
        ControlStep(duration=0.2, controls=SimpleControllerState(boost=True,throttle=1,jump=True,pitch=-0.3,roll=1)),
        ControlStep(duration=0.4, controls=SimpleControllerState(boost=True,throttle=1, pitch=-1)),
        ControlStep(duration=0.1, controls=SimpleControllerState(throttle=1, pitch=-1, steer=0.4)),
        ControlStep(duration=0.35, controls=SimpleControllerState(throttle=1)),
        ControlStep(duration=0.01, controls=SimpleControllerState(throttle=1,pitch=1)),
        ControlStep(duration=0.14, controls=SimpleControllerState(jump=True,throttle=1)),
        ControlStep(duration=0.05, controls=SimpleControllerState(jump=False,throttle=1)),
